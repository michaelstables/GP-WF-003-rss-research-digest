...
Open `Set Workflow Inputs` and replace the sample values with your own RSS feed URL, topic lens, target audience, digest goal, max item count, and fallback items.
