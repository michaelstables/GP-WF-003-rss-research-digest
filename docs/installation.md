...
This guide walks through importing the RSS Research Digest into n8n.
...
The workflow should create a dated Google Doc with the finished rss research digest output.
